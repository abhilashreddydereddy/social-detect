"""
Single-image real-vs-AI classifier for the image branch (CIFake and similar).

Default: EfficientNet spatial backbone + optional FFT frequency branch,
mirroring the MFAD visual encoder pattern but without audio/meta.
"""
...
class ImageClassifier(nn.Module):
    ...
    def forward(self, images: torch.Tensor) -> dict[str, torch.Tensor]:
        ...
        Returns logits (B, C), probs, p_fake.
        """
